...
function TabsContent({ value, children, className }: TabsContentProps) {
  ...
  return (
    <div
      role="tabpanel"
      className={cn(
        "mt-2 ring-offset-[hsl(var(--background))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2 animate-fade-in",
        className
      )}
    >
      {children}
